...
\OCP\App::registerPersonal('ocduplicates', 'personal-settings');

// Register filesystem hooks to remove thumbnails and tags DB entries
\OCP\Util::connectHook('OC_Filesystem', 'delete', 'OCA\OCDuplicates\utilities', 'removeItem');
\OCP\Util::connectHook('OC_Filesystem', 'post_write', 'OCA\OCDuplicates\utilities', 'addItem');